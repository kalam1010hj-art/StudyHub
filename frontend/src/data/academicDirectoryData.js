...
export const universities = [
  {
    ...
    collegeCount: 120,
    description:
      "A major public technological university serving engineering and technology education.",
  },
  {
    id: 2,
    code: "OU",
    ...
    collegeCount: 95,
    description:
      "A historic university with a broad range of undergraduate and postgraduate programs.",
  },
  {
    id: 3,
    code: "KU",
    ...
    collegeCount: 72,
    description:
      "A multidisciplinary university with programs across science, technology and humanities.",
  },
  {
    id: 4,
    code: "BRAOU",
    ...
    collegeCount: 54,
    description:
      "Open and distance learning programs designed for flexible study.",
  },
  {
    id: 5,
    code: "ANU",
    ...
    collegeCount: 88,
    description:
      "A comprehensive university offering programs across multiple disciplines.",
  },
  {
    id: 6,
    code: "VTU",
    ...
    collegeCount: 210,
    description:
      "A leading technological university with a large affiliated college network.",
  },
  {
    id: 7,
    code: "AU",
    ...
    collegeCount: 82,
    description:
      "A prominent university offering diverse academic and professional programs.",
  },
  {
    id: 8,
    code: "ANNA",
    ...
    collegeCount: 120,
    description:
      "A major technical university known for engineering and technology education.",
  },
];
...
export const colleges = [
  {
    id: 1,
    code: "MRITS",
    name: "Mahbubnagar Institute of Technology & Science",
