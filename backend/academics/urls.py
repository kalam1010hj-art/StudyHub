...
from .views import UniversityView,UnviersityDetailsView,CollegeDetailsView,CollegeView,DegreeView,DegreeDetailsView,BranchView,BranchDetailsView,SemesterView,SemesterDetailsView,SubjectView,SubjectDetailsView,ResourceDetailsView,ResourceView,CollegeProgramDetailsView,CollegeProgramView
urlpatterns = [
